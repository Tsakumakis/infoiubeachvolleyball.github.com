const translations = {
    'en': {
        ...
        'reg-info-text': 'To register for the tournament, you must be a student or a friend of the Ionian University. Please complete the registration form available on our website from May 6th to May 16th (ATTENTION: No applications will be accepted after May 16th). You will need to provide your team name, player names, and contact information. Once you submit the form, you will be notified of your match schedule within 2 weeks. It is also important to let us know if you have played for an indoor volleyball team or participated in a tournament in the past.',
        'advice-title': 'Advice',
        'advice-text': 'Our Co-ed Division is all about having a great time and meeting new people. We’re specifically looking for more guys to join the mix—so if you’ve been hesitant because you’re not a "pro" yet, this is the spot for you.',
        'important-title': 'Important',
        'important-text': 'We strongly advise you to come 30 minutes earlier than your scheduled match so we can be sure that you are there and can warm up properly.',
        'rules-title': 'Rules',
        'rules-intro': 'Here are the rules for the tournament:',
        'rule-1': 'Teams must consist of two players. (No substitutes)',
        'rule-2': 'Matches will be played in a best-of-three sets format up to 21 points.',
    ...
    'el': {
        ...
        'advice-text': 'Η μικτή κατηγορία μας έχει ως στόχο τη διασκέδαση και τη γνωριμία με νέο κόσμο. Ψάχνουμε συγκεκριμένα περισσότερα άτομα για την μικτή κατηγορία — οπότε αν διστάζατε επειδή δεν είστε ακόμα "επαγγελματίες", αυτή είναι η κατάλληλη κατηγορία για εσάς.',
        'important-title': 'Σημαντικό',
        'important-text': 'Σας συμβουλεύουμε να προσέλθετε 30 λεπτά νωρίτερα από τον προγραμματισμένο αγώνα σας, ώστε να είμαστε σίγουροι ότι είστε εκεί και να κάνετε σωστή προθέρμανση.',
        'rules-title': 'Κανόνες',
        'rules-intro': 'Ακολουθούν οι κανόνες του τουρνουά:',
        'rule-1': 'Οι ομάδες αποτελούνται από δύο παίκτες. (Χωρίς αλλαγές)',
